...
onboarding_path = "/Users/usuario2/Documents/eatcloud-docs-framework/docs/bo-onboarding-standards.md"

bo_md = """# EatCloud BackOffice - Onboarding Standards
...
print("bo-onboarding-standards.md creado.")
