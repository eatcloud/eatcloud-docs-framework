# configuración-de-número-máximo-de-beneficiarios-finales-por-tipología-b.aspx

0x0101009D1CB255DA76424F860D91F20E6C411800C12E4AF3524183439921C4A8ABBCA98F 
 Article 

 Label Ttulo de la Vista: 
 lb_cnf_max_fibe_x_doma_tip_b ( https://datagov.eatcloud.info/api/eatcloud/eatc_config_labels?plataforma=beneficiarios&idlabel= lb_cnf_max_fibe_x_doma_tip_b )  

 Label Descripcin de la Vista: 
 lb_cnf_max_fibe_x_doma_tip_b_desc ( https://datagov.eatcloud.info/api/eatcloud/eatc_config_labels?plataforma=beneficiarios&idlabel= lb_cnf_max_fibe_x_doma_tip_b_desc )  

 Cuando no hay registros en el respectivo repositorio de tipologas b 
 El sistema debe realizar la siguiente consulta: 
 {{URL_entorno_donantes}}/api/{{_DOM. cua_master }}/eatc_doma_typology_b?_id=_* 
 ...
 FORMULARIO PARA CREACIN DE LMITE MXIMO DE BENEFICIARIOS FINALES QUE PUEDEN SER ATENDIDOS SEGN LA TIPOLOGA B DE LOS GESTORES DE DONACIN 
 ...
 Informacin tcnica del parmetro: eatc_max_fibe_x_doma_typology_b. eatc_doma_typology_b 
 Tipo de dato: string 
...
{{URL_entorno_beneficiarios}}/api/{{_DOM. cua_master }}/eatc_max_fibe_x_doma_typology_b? eatc_doma_typology_b ={{eatc_doma_typology_b. eatc_code }} 

 Cantidad mxima de beneficiarios finales para organizaciones en la anterior tipologa (B) 
 Label: 
 lb_max_fibe_x_doma_tip_b ( https://datagov.eatcloud.info/api/eatcloud/eatc_config_labels?plataforma=beneficiarios&idlabel= lb_max_fibe_x_doma_tip_b )  

 Caracterizacin del Input: 
 Informacin tcnica del parmetro: eatc_max_fibe_x_doma_typology_b. cantidad_maxima_ben_final 
 Tipo de dato: integer 
 Tipo de input: number input 
 Obligatoriedad : si 
 Validacin : obligatoriedad 
 Se guarda en (para efectos indicativos, no prcticos) :  
{{URL_entorno_beneficiarios}}/api/{{_DOM. cua_master }}/eatc_max_fibe_x_doma_typology_b? cantidad_maxima_ben_final ={{number_input}} 

 Llamado al CRD para realizar el registro 
 {{URL_entorno_beneficiarios}}/crd/{{_DOM.cua_master}}/?_tabla= eatc_max_fibe_x_doma_typology_b &_operacin= insert & eatc_doma_typology_b ={{eatc_doma_typology_b. eatc_code }}& cantidad_maxima_ben_final ={{number_input}} 

 LISTADO DE REGISTROS REALIZADOS (PARA CONSULTAR Y EDITAR) 

 El sistema debe realizar la siguiente consulta: 
 {{URL_entorno_beneficiarios}}/api/{{_DOM. cua_master }}/eatc_max_fibe_x_doma_typology_b? eatc_doma_typology_b =_* 
 ...
 Tipologa B 
 Label: 
 lb_tip_b (https://datagov.eatcloud.info/api/eatcloud/eatc_config_labels?plataforma=beneficiarios&idlabel= lb_tip_b ) 
 De donde se toma la informacin: eatc_max_fibe_x_doma_typology_b. eatc_doma_typology_b 
...
{{URL_entorno_beneficiarios}}/api/{{_DOM. cua_master }}/eatc_max_fibe_x_doma_typology_b? eatc_doma_typology_b ={{eatc_doma_typology_b. eatc_code }} 
 ...
 Cantidad mxima de beneficiarios finales 
 Label: 
 lb_max_fibe ( https://datagov.eatcloud.info/api/eatcloud/eatc_config_labels?plataforma=beneficiarios&idlabel= lb_max_fibe )  

 Caracterizacin del Input: 
 De donde se toma la informacin: eatc_max_fibe_x_doma_typology_b. cantidad_maxima_ben_final 
...
{{URL_entorno_beneficiarios}}/api/{{_DOM. cua_master }}/eatc_max_fibe_x_doma_typology_b. cantidad_maxima_ben_final ={{number_input}} 
 ...
 CONFIGURACIN DE NMERO MXIMO DE BENEFICIARIOS FINALES POR TIPOLOGA B DE GESTOR DE DONACINES