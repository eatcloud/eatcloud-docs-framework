# upgrade-por-anuncios-de-donación.aspx

0x0101009D1CB255DA76424F860D91F20E6C411800C12E4AF3524183439921C4A8ABBCA98F 
 Article 

 URL&#58; &#123;&#123;URL_entorno_datagov&#125;&#125;/_dgbo/#!/upgrade_by_dona 
...
&#160; 
 Has superado el lmite de donaciones por punto de donacin mensuales de tu plan rescate (concat) &#123;&#123;Plan_de_rescate&#125;&#125; 
 class= lbl_has_superado_limite_dona ( https&#58;//dev.datagov.eatcloud.info/api/eatcloud/eatc_config_labels?plataforma=datagov_cuentas&amp;lang=_*&amp;pais=_*&amp;idlabel= lbl_has_superado_limite_dona )&#160; 
&#160; 
 &#123;&#123;Plan_de_rescate&#125;&#125; 
 &#123;&#123; URL_entorno_datagov &#125;&#125;/api/eatcloud/ eatc_cua ?name=&#123;&#123;_DOM. cua_user &#125;&#125;&amp;_distinct =type 
&#160; 
 ***PENDIENTE&#58; Un total de (concat) &#123;&#123;numero_puntos&#125;&#125; (concat) punto(s) de donacin ha(n) intentado realizar ms donaciones de las que posibilita tu actual plan.**** 
 &#160;class= lbl_un_total_de ( https&#58;//dev.datagov.eatcloud.info/api/eatcloud/eatc_config_labels?plataforma=datagov_cuentas&amp;lang=_*&amp;pais=_*&amp;idlabel= lbl_un_total_de )&#160; 
&#160; 
 ***&#123;&#123;numero_puntos&#125;&#125;**** 
 cont de la consulta&#58; 
 &#123;&#123; URL_entorno_datagov &#125;&#125;/api/eatcloud/ eatc_upgrade_events?eatc_cua= &#123;&#123;_DOM. cua_user &#125;&#125; &amp;eatc_upgrade_event=eatc_dona_x_pod_mes_limit&amp;eatc_actual_rescue_plan= &#123;&#123;eatc_cua. type &#125;&#125;&amp;_distinct= eatc_user 

&#160; 
 class= lbl_pods_con_mas_dona ( https&#58;//dev.datagov.eatcloud.info/api/eatcloud/eatc_config_labels?plataforma=datagov_cuentas&amp;lang=_*&amp;pais=_*&amp;idlabel= lbl_pods_con_mas_dona )&#160;&#160; 

&#160; 
 Actualiza tu plan de rescate (concat) para crear ms donaciones por punto en el mes 
...
&#160; 
 class= lbl_para_crear_mas_dona ( https&#58;//dev.datagov.eatcloud.info/api/eatcloud/eatc_config_labels?plataforma=datagov_cuentas&amp;lang=_*&amp;pais=_*&amp;idlabel= lbl_para_crear_mas_usr_adm ) 
 ...
 UPGRADE POR ANUNCIOS DE DONACIN