# upgrade-por-bloqueo-de-usuarios.aspx

0x0101009D1CB255DA76424F860D91F20E6C411800C12E4AF3524183439921C4A8ABBCA98F 
 Article 

 URL&#58; &#123;&#123;URL_entorno_datagov&#125;&#125;/_dgbo/#!/upgrade_by_user_block 
...
&#160; 
 Tu plan (concat) &#123;&#123;Plan_de_rescate&#125;&#125; (concat) no cuenta con la funcionalidad (concat) de bloqueo de usuarios beneficiarios. 
...
&#160; 
 class= lbl_bloqueo_usuarios_beneficiarios ( https&#58;//dev.datagov.eatcloud.info/api/eatcloud/eatc_config_labels?plataforma=datagov_cuentas&amp;lang=_*&amp;pais=_*&amp;idlabel= lbl_bloqueo_usuarios_beneficiarios )&#160;&#160; 
&#160; 
 Actualiza tu plan de rescate (concat) para contar con esta funcionalidad que te permite bloquear beneficiarios especficos, para que no accedan a tus donaciones. 
...
&#160; 
 class= lbl_para_bloqueo_usuarios_beneficiarios ( https&#58;//dev.datagov.eatcloud.info/api/eatcloud/eatc_config_labels?plataforma=datagov_cuentas&amp;lang=_*&amp;pais=_*&amp;idlabel= lbl_para_bloqueo_usuarios_beneficiarios )&#160; 
...
Informacin Planes 
 ...
 UPGRADE POR BLOQUEO DE USUARIOS