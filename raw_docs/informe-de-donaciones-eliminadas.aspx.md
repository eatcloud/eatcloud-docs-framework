# informe-de-donaciones-eliminadas.aspx
...
&#160; 
 ...
 Subttulo&#58; 
 class=&quot; lbl_filtro_fechas &quot; ( https&#58;//datagov.eatcloud.info/api/eatcloud/eatc_config_labels? plataforma =beneficiarios&amp;idlabel=lbl_filtro_fechas )&#160; 
&#160; 
 Filtro&#58; &quot;Hoy&quot; 
...
&#160; 
 ...
 Filtro por cuentas (selector mltiple, con opcin &quot;Todas&quot;) 
 Seleccionar cuenta&#58; 
...
&#160; 
 Consulta de las cuentas que borraron donaciones en las fechas establecidas (para armar el selector mltiple)&#58; 
 &#123;&#123;URL_entorno_donantes&#125;&#125;/api/&#123;&#123;_DOM. cua_master &#125;&#125;/ eatc_deleted_dona_header ? eatc-publication_date[0]= &#123;&#123;fecha_inicial&#125;&#125;&amp; eatc-publication_date[1]= &#123;&#123;fecha_final&#125;&#125;&amp;_distinct= eatc-donor 
&#160; 
...
&#160; 
 Con las respuestas, el sistema arma un selector mltiple que permitir seleccionar una, varias o todas las ciudades presentes en el selector.&#160; Una vez el usuario realice su seleccin, con ella el sistema arma un &#123;&#123; array_de_donantes &#125;&#125; que utiliza para la siguiente consulta&#58; 
...
&#160; 
 Con la seleccin anterior de fechas y el &#123;&#123; array_de_donantes &#125;&#125; , el sistema deber realizar la siguiente consulta&#58; 
&#160; 
 Consulta de las ciudades en donde hay donaciones eliminadas para los donantes seleccionados (para armar el selector)&#58; 
 &#123;&#123;URL_entorno_donantes&#125;&#125;/api/&#123;&#123;_DOM. cua_master &#125;&#125;/ eatc_deleted_dona_header ? eatc-publication_date[0]= &#123;&#123;fecha_inicial&#125;&#125;&amp; eatc-publication_date[1]= &#123;&#123;fecha_final&#125;&#125;&amp;eatc-donor= &#123;&#123; array_de_donantes &#125;&#125; &amp;_distinct= eatc-city 
&#160; 
 Si no se obtienen resultados en la consulta , se muestra el toast &quot;No se obtubieron resultados &quot;&#160; class=&quot; lbl_toast_sin_resultados &quot; https&#58;//datagov.eatcloud.info/api/eatcloud/eatc_config_labels?plataforma=beneficiarios&amp;idlabel=lbl_toast_sin_resultados 
...
&#160; 
 ...
 &#123;&#123;URL_entorno_donantes&#125;&#125;/api/&#123;&#123;_DOM. cua_master &#125;&#125;/ eatc_dona_header_state_history ? eatc-dona_header_code = &#123;&#123; array_codigos_anuncios_eliminados &#125;&#125; &amp; eatc-state = deleted &amp;_cmp=eatc-date_time,eatc_doma_user_doc_id 
...
&#160; 
 ...
 https&#58;//datagov.eatcloud.info/api/eatcloud/eatc_config_labels?plataforma=beneficiarios&amp;idlabel=lbl_codigo_anuncio &#160; 
&#160; 
 Orden&#58; 1ra columna 
...
&#160; 
 ...
 https&#58;//datagov.eatcloud.info/api/eatcloud/eatc_config_labels?plataforma=beneficiarios&amp;idlabel= lbl_fecha &#160; 
&#160; 
 Orden&#58; 2da columna 
...
&#160; 
 ...
 https&#58;//datagov.eatcloud.info/api/eatcloud/eatc_config_labels?plataforma=beneficiarios&amp;idlabel= lbl_fecha_hora &#160; 
&#160; 
 Orden&#58; 3ra columna 
...
&#160; 
 ...
 https&#58;//datagov.eatcloud.info/api/eatcloud/eatc_config_labels?plataforma=beneficiarios&amp;idlabel= lbl_estado 
&#160; 
 Orden&#58; 5 ta columna 
...
&#160; 
 ...
 https&#58;//datagov.eatcloud.info/api/eatcloud/eatc_config_labels?plataforma=beneficiarios&amp;idlabel= lbl_tipo_creacion 
&#160; 
 Orden&#58; 6ta columna 
...
&#160; 
 ...
 https&#58;//datagov.eatcloud.info/api/eatcloud/eatc_config_labels?plataforma=beneficiarios&amp;idlabel= lbl_codigo_punto_donacion 
&#160; 
 Orden&#58; /ma columna 
...
&#160; 
 Punto de donacin 
 Label &#58; class=&quot; lbl_pod &quot; 
 https&#58;//datagov.eatcloud.info/api/eatcloud/eatc_config_labels?plataforma=beneficiarios&amp;idlabel= lbl_pod 
&#160; 
 Orden&#58; 8va columna 
...
&#160; 
 ...
 https&#58;//datagov.eatcloud.info/api/eatcloud/eatc_config_labels?plataforma=beneficiarios&amp;idlabel= lbl_direccion_pod 
&#160; 
 Orden&#58; 9na columna 
...
&#160; 
 ...
 https&#58;//datagov.eatcloud.info/api/eatcloud/eatc_config_labels?plataforma=beneficiarios&amp;idlabel= lbl_ciudad 
&#160; 
 Orden&#58; 10ma columna 
...
&#160; 
 ...
 https&#58;//datagov.eatcloud.info/api/eatcloud/eatc_config_labels?plataforma=beneficiarios&amp;idlabel= lbl_departamento_provincia_estado 
&#160; 
 Orden&#58; 11ava columna 
...
&#160; 
 ...
 https&#58;//datagov.eatcloud.info/api/eatcloud/eatc_config_labels?plataforma=beneficiarios&amp;idlabel= kg_originales 
&#160; 
 Orden&#58; 13ava columna 
...
&#160; 
 ...
 https&#58;//datagov.eatcloud.info/api/eatcloud/eatc_config_labels?plataforma=beneficiarios&amp;idlabel= 
&#160; 
 Orden&#58; 14ava&#160; columna 
...
&#160; 
 ...
 https&#58;//datagov.eatcloud.info/api/eatcloud/eatc_config_labels?plataforma=beneficiarios&amp;idlabel= lbl_direccion_beneficiario 
&#160; 
 Orden&#58; 15ava&#160; columna 
...
&#160; 
 ...
 https&#58;//datagov.eatcloud.info/api/eatcloud/eatc_config_labels?plataforma=beneficiarios&amp;idlabel= lbl_telefono_beneficiario 
&#160; 
 Orden&#58; 16ava&#160; columna 
...
&#160; 
 ...
 https&#58;//datagov.eatcloud.info/api/eatcloud/eatc_config_labels?plataforma=beneficiarios&amp;idlabel= lbl_hora_adjudicacion 
&#160; 
 Orden&#58; 18ava&#160; columna 
...
&#160; 
 ...
 https&#58;//datagov.eatcloud.info/api/eatcloud/eatc_config_labels?plataforma=beneficiarios&amp;idlabel= lbl_fecha_eliminacion 
&#160; 
 Orden&#58; 19ava columna 
...
&#160; 
 ...
 https&#58;//datagov.eatcloud.info/api/eatcloud/eatc_config_labels?plataforma=beneficiarios&amp;idlabel= lbl_usuario_eliminacion 
&#160; 
 Orden&#58; 20ava columna 
...
&#160; 
 ...
 https&#58;//datagov.eatcloud.info/api/eatcloud/eatc_config_labels?plataforma=beneficiarios&amp;idlabel= lbl_doc_id_donante 
&#160; 
 Orden&#58; 21ava columna 
...
&#160; 
 ...
 https&#58;//datagov.eatcloud.info/api/eatcloud/eatc_config_labels?plataforma=beneficiarios&amp;idlabel= lbl_documento_soporte 
&#160; 
 Orden&#58; 22ava columna 
 ...
 https://eatcloudcorp.sharepoint.com/_layouts/15/getpreview.ashx?path=%2Fsites%2FEatCloud2%2FSiteAssets%2FSitePages%2Finforme-de-donaciones-eliminadas%2F1006270722-filtro_mis_resultados--4-.jpg&ow=1273&oh=181, https://eatcloudcorp.sharepoint.com/_layouts/15/getpreview.ashx?path=%2Fsites%2FEatCloud2%2FSiteAssets%2FSitePages%2Finforme-de-donaciones-eliminadas%2F1006270722-filtro_mis_resultados--4-.jpg&ow=1273&oh=181 
 BO Beneficiarios 
