# resumen-pedido-licencias-rescate.aspx

0x0101009D1CB255DA76424F860D91F20E6C411800C12E4AF3524183439921C4A8ABBCA98F 
 Article 

 El siguiente wireframe, presenta el diseo para una pgina que tambin servir para la realizacin del proceso de check-out pero que en una primera fase, servir para confirmar un pedido, realizando la integracin con el ERP de Alegra para generar una factura. 

 Label Ttulo de la Vista&#58; &quot;Actualiza tu plan&quot; 
 class=lbl_actualiza_plan ( https&#58;//datagov.eatcloud.info/api/eatcloud/eatc_config_labels?plataforma=datagov_cuentas&amp;idlabel= lbl_actualiza_plan )&#160; 
&#160; 
...
&#160; 
 ...
 &#123;&#123; URL_entorno_datagov &#125;&#125;/api/eatcloud/ eatc_licenses_prices ?country=&#123;&#123;eatc_cua. eatc_country &#125;&#125;&amp;cua_type_period=&#123;&#123;eatc_cua. type_period &#125;&#125;&amp;cua_type=&#123;&#123;eatc_cua. type &#125;&#125; 
&#160; 
...
&#160; 
 &#123;&#123;type_actual&#125;&#125;&#160; 
 El sistema deber guardar en una variable el tipo de licencia actual &#123;&#123;eatc_cua. type &#125;&#125; (antes de la actualizacin) para posibles reversiones de registros. 
&#160; 
 &#123;&#123;nombre_del_plan_actual&#125;&#125; - &#123;&#123;pods_activos&#125;&#125; puntos de donacin 
 &#123;&#123;eatc_licenses_prices . name &#125;&#125; - &#123;&#123; pods_activos &#125;&#125; class=lbl_pods ( https&#58;//datagov.eatcloud.info/api/eatcloud/eatc_config_labels?plataforma=datagov_cuentas&amp;idlabel= lbl_pods ) 
&#160; 
 &#123;&#123;moneda&#125;&#125; &#123;&#123;precio_actual&#125;&#125; por punto de donacin 
...
&#160; 
 Total&#58; &#123;&#123;pods_activos&#125;&#125; * &#123;&#123;precio_actual&#125;&#125; 
 Con los valores obtenidos se concatena la siguiente informacin&#58; 
 class= lbl_total ( https&#58;//datagov.eatcloud.info/api/eatcloud/eatc_config_labels?plataforma=datagov_cuentas&amp;idlabel= lbl_valor_unitario )&#58; &#123;&#123;pods_activos&#125;&#125; * &#123;&#123;precio_actual&#125;&#125; &#160; 
&#160; 
...
&#160; 
 ...
 &#123;&#123; URL_entorno_datagov &#125;&#125;/api/eatcloud/ eatc_licenses_prices ?country=&#123;&#123;eatc_cua. eatc_country &#125;&#125;&amp;cua_type_period=&#123;&#123;eatc_cua. type_period &#125;&#125;&amp;cua_type= &#123;&#123;eatc_details_of_licenses .eatc_licence_code &#125;&#125; 
&#160; 
 Y tambin recuperar las variables que a continuacin se relacionan&#58; 
&#160; 
 &#123;&#123;nombre_del_nuevo_plan&#125;&#125; 
 &#123;&#123;eatc_licenses_prices . name &#125;&#125; &#160; 
 (&#123;&#123; URL_entorno_datagov &#125;&#125;/api/eatcloud/ eatc_licenses_prices ?country=&#123;&#123;eatc_cua. eatc_country &#125;&#125;&amp;cua_type_period=&#123;&#123;eatc_cua. type_period &#125;&#125;&amp;cua_type=&#123;&#123;eatc_details_of_licenses. eatc_licence_code &#125;&#125;&amp;_distinct= name ) 
&#160; 
 ...
 ***AJUSTE&#58; Actualmente tienes &#123;&#123;pods_activos&#125;&#125; &#160; Puntos de donacin activos *** 
 ...
 Depreacado&#58; Nota &#58; en el diseo aparecen botones para adicionar o quitar puntos de donacin, que en primera instancia no deben ser implemenados, solamente se presenta el valor de puntos activos para la respectiva cuenta, tal como se obtuvo en la pantalla anterior . 
 ...
 ***NUEVO&#58; Colapsible&#58; &quot;Observaciones de la facturacin&quot; *** 

 Label Ttulo del colapsible&#58; &quot;Observaciones sobre la facturacin&quot; 
 class=lbl_obs_facturacion ( https&#58;//datagov.eatcloud.info/api/eatcloud/eatc_config_labels?plataforma=datagov_cuentas&amp;idlabel= lbl_obs_facturacion )&#160;&#160;&#160;&#160; 
&#160; 
...
&#160; 
 class=lbl_obs_facturacion_1 ( https&#58;//datagov.eatcloud.info/api/eatcloud/eatc_config_labels?plataforma=datagov_cuentas&amp;idlabel= lbl_obs_facturacion_1 )&#160;&#160;&#160; 
&#160; 
 class=lbl_obs_facturacion_2 ( https&#58;//datagov.eatcloud.info/api/eatcloud/eatc_config_labels?plataforma=datagov_cuentas&amp;idlabel= lbl_obs_facturacion_2 )&#160;&#160;&#160; 
&#160; 
 class=lbl_obs_facturacion_3 ( https&#58;//datagov.eatcloud.info/api/eatcloud/eatc_config_labels?plataforma=datagov_cuentas&amp;idlabel= lbl_obs_facturacion_3 )&#160;&#160;&#160; 
...
&#160; 
 ...
 Determinacin del &#123;&#123;valor_a_facturar&#125;&#125; si existe una factura pagada para el periodo actual de facturacin 
...
&#160; 
 &#123;&#123;diferencia_precios_licencias&#125;&#125; = ( &#123;&#123;pods_activos&#125;&#125; * &#123;&#123;precio&#125;&#125; ) - ( &#123;&#123;pods_activos&#125;&#125; * &#123;&#123;precio_actual&#125;&#125; ) 
&#160; 
...
&#160; 
 ***NUEVO&#58; Con esta actualizacin tu cuenta EatCloud pasar a tener licencia de rescate &#123;&#123;nombre_del_nuevo_plan&#125;&#125;&#160; con &#123;&#123;pods_activos&#125;&#125; Puntos de donacin activos *** 
 class=lbl_con_esta_actualizacion ( https&#58;//datagov.eatcloud.info/api/eatcloud/eatc_config_labels?plataforma=datagov_cuentas&amp;idlabel= lbl_con_esta_actualizacion ) &#123;&#123;nombre_del_nuevo_plan&#125;&#125; class=lbl_con ( https&#58;//datagov.eatcloud.info/api/eatcloud/eatc_config_labels?plataforma=datagov_cuentas&amp;idlabel= lbl_con )&#160; &#123;&#123; pods_activos &#125;&#125; class= lbl_pods_activos ( https&#58;//datagov.eatcloud.info/api/eatcloud/eatc_config_labels?plataforma=datagov_cuentas&amp;idlabel= lbl_pods_activos ) 
...
&#160; 
 ...
 class=lbl_confirmacion_pedido ( https&#58;//datagov.eatcloud.info/api/eatcloud/eatc_config_labels?plataforma=datagov_cuentas&amp;idlabel= lbl_confirmacion_pedido )&#160; 
&#160; 
 Recuerda que al actualizar tu plan, cambiarn los valores facturables por concepto de licencia rescate, del precio de la licencia anterior, al precio de la nueva licencia por punto de donacin. 
&#160; 
 Botn&#58; &quot;No, cancelar&quot; 
...
&#160; 
 ...
 &#123;&#123; URL_entorno_datagov &#125;&#125;/crd/eatcloud/?_tabla= eatc_cua &amp;_operacion= _update &amp;type=&#123;&#123;Cdigo de la nueva licencia adquirida&#58; eatc_details_of_licenses .eatc_licence_code &#125;&#125;&amp;type_period=&#123;&#123; lbl_anual_ahoras_15pc/lbl_mensual &#125;&#125;&amp;WHEREname=&#123;&#123;_DOM.cua_user&#125;&#125; 
&#160; 
...
&#160; 
 Una vez se haya creado el cliente en el ERP, o si en la evaluacin anterior se determina que existe un dato vlido en eatc_customers. erp_id &#160; (lo que es indicativo de que el cliente ya ha sido creado en el ERP), se procede, con los datos obtenidos con anterioridad en en el flujo de proceso y otros datos que se detallan ms adelante, a saber&#58; 
&#160; 
...
&#160; 
 &#123;&#123; URL_entorno_datagov &#125;&#125;/crd/eatcloud/?_tabla= eatc_cua &amp;_operacion= _update &amp;type= &#123;&#123; type_actual &#125;&#125; &amp;WHEREname= &#123;&#123;_DOM. cua_user &#125;&#125; 
&#160; 
 Etapa 2&#58; CON implementacin de pago electrnico PENDIENTE 
...
&#160; 
 ...
 https://eatcloudcorp.sharepoint.com/_layouts/15/getpreview.ashx?path=%2Fsites%2FEatCloud2%2FSiteAssets%2FSitePages%2Fresumen-pedido-licencias-rescate%2F3637400608-resumen_pedido_2_enc.jpg&ow=1127&oh=189, https://eatcloudcorp.sharepoint.com/_layouts/15/getpreview.ashx?path=%2Fsites%2FEatCloud2%2FSiteAssets%2FSitePages%2Fresumen-pedido-licencias-rescate%2F3637400608-resumen_pedido_2_enc.jpg&ow=1127&oh=189 

 468.000000000000 

 RESUMEN DE PEDIDO LICENCIAS RESCATE