# upgrade-por-fechas-informe-donaciones.aspx

0x0101009D1CB255DA76424F860D91F20E6C411800C12E4AF3524183439921C4A8ABBCA98F 
 Article 

 URL&#58; &#123;&#123;URL_entorno_datagov&#125;&#125;/_dgbo/#!/ upgradebydonainfodates 
...
&#160; 
 ...
 eatc_upgrade_event = upgrade_by_dona_info_dates 
...
&#160; 
 Tu plan (concat) &#123;&#123;Plan_de_rescate&#125;&#125; (concat) no cuenta con la funcionalidad (concat) de configuracin de fechas para los informes de donaciones. 
...
&#160; 
 class= lbl_cnf_fechas_info_donaciones ( https&#58;//dev.datagov.eatcloud.info/api/eatcloud/eatc_config_labels?plataforma=datagov_cuentas&amp;lang=_*&amp;pais=_*&amp;idlabel= lbl_cnf_fechas_info_donaciones )&#160;&#160;&#160; 
&#160; 
 Actualiza tu plan de rescate (concat) para contar con esta funcionalidad que te permite configurar diferentes rangos de fechas para los informes de donaciones. 
...
&#160; 
 class= lbl_para_cnf_fechas_info_donaciones ( https&#58;//dev.datagov.eatcloud.info/api/eatcloud/eatc_config_labels?plataforma=datagov_cuentas&amp;lang=_*&amp;pais=_*&amp;idlabel= lbl_para_cnf_fechas_info_donaciones )&#160;&#160; 
