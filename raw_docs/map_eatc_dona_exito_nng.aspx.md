...
&#160; 
 ***NUEVO*** 
 eatc-doc = Orden Despacho/Devolucion ID //Documento soporte de la transaccin (se utiliza cuando se tiene un documento soporte que no puede utilizarse como cdigo del encabezado) 
&#160; 
&#160; 
...
&#160; 
 ***NUEVO*** 
 eatc-odd_code = EAN //Cdigo internacional del artculo o producto susceptible a ser donado. 
&#160; 
 eatc-odd_original_quantity = # Unidades Despachadas// Cantidad original del producto o artculo donado 
 ...
 eatc_VAT_percentage = Tarifa IVA //Porcentaje del impuesto al valor agregado aplicable al artculo.&#160; En una primera instancia lo enviarn vaco. 
 ...
 origin_odds_typology_c = //Segunda tipologa origen del artculo o producto donado 
 eatc-provider_id = Proveedor Nit// Cdigo del proveedor del artculo 
 eatc-return_cause_code = Causa de Devolucion Causa Devolucion ID//Cdigo del causal de devolucin 
 eatc-return_cause = Causa de Devolucion Causa Devolucion DESC// Descripcin del causal de devolucin 
&#160; 
 #tipo de transformacin 
 m2z-map-type = cambio_nombre_campo //adicion_columnas,cambio_nombre_campo 
&#160; 
 #querys 
 eatc-odd_external_code = eatc_odds.eatc-id https&#58;//devdonantes.eatcloud.info/api/nutresa/eatc_odds?eatc-odd_external_code1=$eatc-odd_id //En la tabla de productos susceptibles a ser donados de nutresa, se enva en el campo eatc-odd_external_code1 el identificador del xito, para obtener el &quot;eatc-id&quot; que en este caso funge como cdigo externo 
...
&#160; 
 ***NUEVO*** 
 eatc-date_time_2 = $current_date -1 (AAAA-MM-DD&#58; se coloca la fecha del da inmediatamente anterior) 
 eatc-dona_header_code = concat($ eatc-date_time_2 ,$ eatc-pod_id,nng,$eatc_donor) //Cdigo de la cabecera del anuncio de donacin. Concatenar la fecha actual con el cdigo de la dependencia y el sufijo &quot;nng&quot; (similar a como se maneja el cdigo de las donaciones de artculos propios del xito, pero con el sufijo nng y el nombre del donante 
&#160; 
...
&#160; 
 ...
 eatc-warning = //Se coloca informacin segn lo planteado aqu 
...
&#160; 
 ...
 MAP_EATC_DONA_EXITO_NGG PILOTO NUTRESA