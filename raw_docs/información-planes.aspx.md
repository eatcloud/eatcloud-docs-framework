...
&#160; 
 &#123;&#123; URL_entorno_datagov &#125;&#125;/api/eatcloud/ eatc_details_of_licenses? eatc_licence_code =_*&amp; _distinct =eatc_licence_code 
&#160; 
 Ambiente de pruebas&#58; https&#58;//dev.datagov.eatcloud.info/api/eatcloud/ eatc_details_of_licenses? eatc_licence_code =_*&amp; _distinct =eatc_licence_code &#160; 
 Ambiente de produccin&#58; https&#58;//dev.datagov.eatcloud.info/api/eatcloud/ eatc_details_of_licenses? eatc_licence_code =_*&amp; _distinct =eatc_licence_code &#160; 

 Las cards dispondrn la informacin de la siguiente manera&#58; 
&#160; 
 T IPO DE LICENCIA (ANTERIORMENTE&#58; NOMBRE DE LA LICENCIA ) 
 Mostrar el label que se obtiene de la siguiente consulta 
 &#123;&#123; URL_entorno_datagov &#125;&#125;/api/eatcloud/ eatc_types_of_licenses? eatc_code=&#123;&#123;eatc_details_of_licenses .eatc_licence_code &#125;&#125; &amp; _distinct =eatc_name_lbl 
&#160; 
 Ejemplo &#58;&#160; ambiente de pruebas , eatc_details_of_licenses .eatc_licence_code= free 
 https&#58;//dev.datagov.eatcloud.info /api/eatcloud/ eatc_types_of_licenses? eatc_code= free&amp; _distinct =eatc_name_lbl &#160; &#160; 
&#160; 
...
&#160; 
 &#123;&#123; URL_entorno_datagov &#125;&#125;/api/eatcloud/ eatc_licenses_prices ?country=&#123;&#123;eatc_cua. eatc_country &#125;&#125;&amp;cua_type_period=&#123;&#123;eatc_cua. type_period &#125;&#125;&amp;cua_type= impacto &amp;_cmp= name_lbl,description_lbl,cua_pods_inf_limit,cua_pods_sup_limit,cua_mensual_kg_inf_limit,cua_mensual_kg_sup_limit,default_price , default_price_currency 
&#160; 
&#160; 
 Activo&#58; 
 &#123;&#123; URL_entorno_datagov &#125;&#125;/api/eatcloud/ eatc_licenses_prices ?country=&#123;&#123;eatc_cua. eatc_country &#125;&#125;&amp;cua_type_period=&#123;&#123;eatc_cua. type_period &#125;&#125; &amp;eatc_cua_size_code=&#123;&#123;eatc_cua. eatc_cua_size &#125;&#125;&amp;vertical=&#123;&#123;eatc_cua. vertical &#125;&#125; &amp;cua_type= activo &amp;_cmp= name_lbl,description_lbl,cua_pods_inf_limit,cua_pods_sup_limit,cua_mensual_kg_inf_limit,cua_mensual_kg_sup_limit,default_price , default_price_currency 
&#160; 
 Si la anterior consulta no trae resultados entonces se realiza esta&#58; 
&#160; 
 &#123;&#123; URL_entorno_datagov &#125;&#125;/api/eatcloud/ eatc_licenses_prices ?country=&#123;&#123;eatc_cua. eatc_country &#125;&#125;&amp;cua_type_period=&#123;&#123;eatc_cua. type_period &#125;&#125; &amp;vertical=&#123;&#123;eatc_cua. vertical &#125;&#125; &amp;cua_type= activo &amp;_cmp= name_lbl,description_lbl,cua_pods_inf_limit,cua_pods_sup_limit,cua_mensual_kg_inf_limit,cua_mensual_kg_sup_limit,default_price , default_price_currency 
&#160; 
 y si la anterior consulta no trae resultados entonces se realiza esta (la que estaba como nica consulta anteriormente) &#58; 
&#160; 
 &#123;&#123; URL_entorno_datagov &#125;&#125;/api/eatcloud/ eatc_licenses_prices ?country=&#123;&#123;eatc_cua. eatc_country &#125;&#125;&amp;cua_type_period=&#123;&#123;eatc_cua. type_period &#125;&#125;&amp;cua_type= activo &amp;_cmp= name_lbl,description_lbl,cua_pods_inf_limit,cua_pods_sup_limit,cua_mensual_kg_inf_limit,cua_mensual_kg_sup_limit,default_price , default_price_currency 
&#160; 
&#160; 
 Esencial&#58; 
 &#123;&#123; URL_entorno_datagov &#125;&#125;/api/eatcloud/ eatc_licenses_prices ?country=&#123;&#123;eatc_cua. eatc_country &#125;&#125;&amp;cua_type_period=&#123;&#123;eatc_cua. type_period &#125;&#125; &amp;eatc_cua_size_code=&#123;&#123;eatc_cua. eatc_cua_size &#125;&#125;&amp;vertical=&#123;&#123;eatc_cua. vertical &#125;&#125; &amp;cua_type= esencial &amp;_cmp= name_lbl,description_lbl,cua_pods_inf_limit,cua_pods_sup_limit,cua_mensual_kg_inf_limit,cua_mensual_kg_sup_limit,default_price , default_price_currency 
&#160; 
 Si la anterior consulta no trae resultados entonces se realiza esta&#58; 
&#160; 
 &#123;&#123; URL_entorno_datagov &#125;&#125;/api/eatcloud/ eatc_licenses_prices ?country=&#123;&#123;eatc_cua. eatc_country &#125;&#125;&amp;cua_type_period=&#123;&#123;eatc_cua. type_period &#125;&#125; &amp;vertical=&#123;&#123;eatc_cua. vertical &#125;&#125; &amp;cua_type= esencial &amp;_cmp= name_lbl,description_lbl,cua_pods_inf_limit,cua_pods_sup_limit,cua_mensual_kg_inf_limit,cua_mensual_kg_sup_limit,default_price , default_price_currency 
&#160; 
 y si la anterior consulta no trae resultados entonces se realiza esta (la que estaba como nica consulta anteriormente) &#58; 
&#160; 
 &#123;&#123; URL_entorno_datagov &#125;&#125;/api/eatcloud/ eatc_licenses_prices ?country=&#123;&#123;eatc_cua. eatc_country &#125;&#125;&amp;cua_type_period=&#123;&#123;eatc_cua. type_period &#125;&#125;&amp;cua_type= esencial &amp;_cmp= name_lbl,description_lbl,cua_pods_inf_limit,cua_pods_sup_limit,cua_mensual_kg_inf_limit,cua_mensual_kg_sup_limit,default_price , default_price_currency 
&#160; 
...
&#160; 
 IMPACTO 
 https&#58;// dev .datagov.eatcloud.info//api/eatcloud/ eatc_licenses_prices ?country=es&amp;cua_type_period= lbl_anual_ahoras_15pc &amp;eatc_cua_size_code= little_retail &amp;vertical= retail &amp;cua_type= impacto &amp;_cmp= name_lbl,description_lbl,cua_pods_inf_limit,cua_pods_sup_limit,cua_mensual_kg_inf_limit,cua_mensual_kg_sup_limit,default_price , default_price_currency &#160; &#160; 
 Como la consulta trae resultados, se podrn realizar validaciones para mostrar un precio. 
&#160; 
 ACTIVO 
 https&#58;// dev .datagov.eatcloud.info//api/eatcloud/ eatc_licenses_prices ?country=es&amp;cua_type_period= lbl_anual_ahoras_15pc &amp;eatc_cua_size_code= little_retail &amp;vertical= retail &amp;cua_type= activo &amp;_cmp= name_lbl,description_lbl,cua_pods_inf_limit,cua_pods_sup_limit,cua_mensual_kg_inf_limit,cua_mensual_kg_sup_limit,default_price , default_price_currency &#160; 
&#160; 
 Como la consulta no trae resultados se realiza la siguiente&#58; 
 https&#58;// dev .datagov.eatcloud.info//api/eatcloud/ eatc_licenses_prices ?country=es&amp;cua_type_period= lbl_anual_ahoras_15pc &amp;vertical= retail &amp;cua_type= activo &amp;_cmp= name_lbl,description_lbl,cua_pods_inf_limit,cua_pods_sup_limit,cua_mensual_kg_inf_limit,cua_mensual_kg_sup_limit,default_price , default_price_currency &#160; &#160; 
&#160; 
 Como la consulta no trae resultados se realiza la siguiente&#58; 
 https&#58;// dev .datagov.eatcloud.info/api/eatcloud/ eatc_licenses_prices ?country=es&amp;cua_type_period= lbl_anual_ahoras_15pc &amp;cua_type= activo &amp;_cmp= name_lbl,description_lbl,cua_pods_inf_limit,cua_pods_sup_limit,cua_mensual_kg_inf_limit,cua_mensual_kg_sup_limit,default_price , default_price_currency &#160; &#160; 
&#160; 
 Como no se obtiene informacin para obtener un precio, entonces se punta el botn&#58; Consulte su precio con un asesor (como se establece ms adelante) 
&#160; 
 Esencial 
 https&#58;// dev .datagov.eatcloud.info//api/eatcloud/ eatc_licenses_prices ?country=es&amp;cua_type_period= lbl_anual_ahoras_15pc &amp;eatc_cua_size_code= little_retail &amp;vertical= retail &amp;cua_type= esencial &amp;_cmp= name_lbl,description_lbl,cua_pods_inf_limit,cua_pods_sup_limit,cua_mensual_kg_inf_limit,cua_mensual_kg_sup_limit,default_price , default_price_currency &#160; 
&#160; 
 Como la consulta no trae resultados se realiza la siguiente&#58; 
 https&#58;// dev .datagov.eatcloud.info//api/eatcloud/ eatc_licenses_prices ?country=es&amp;cua_type_period= lbl_anual_ahoras_15pc &amp;vertical= retail &amp;cua_type= esencial &amp;_cmp= name_lbl,description_lbl,cua_pods_inf_limit,cua_pods_sup_limit,cua_mensual_kg_inf_limit,cua_mensual_kg_sup_limit,default_price , default_price_currency &#160; &#160; 
&#160; 
 Como la consulta no trae resultados se realiza la siguiente&#58; 
 https&#58;// dev .datagov.eatcloud.info/api/eatcloud/ eatc_licenses_prices ?country=es&amp;cua_type_period= lbl_anual_ahoras_15pc &amp;cua_type= esencial &amp;_cmp= name_lbl,description_lbl,cua_pods_inf_limit,cua_pods_sup_limit,cua_mensual_kg_inf_limit,cua_mensual_kg_sup_limit,default_price , default_price_currency &#160; &#160;&#160; 
&#160; 
 Como no se obtiene informacin para obtener un precio, entonces se punta el botn&#58; Consulte su precio con un asesor (como se establece ms adelante) 
...
&#160; 
 https&#58;// dev .datagov.eatcloud.info/api/eatcloud/ eatc_licenses_prices ?country= ar &amp;cua_type_period= lbl_mensual &amp;cua_type= impacto &#160;&#160; 
&#160; 
 https&#58;// dev .datagov.eatcloud.info/api/eatcloud/ eatc_licenses_prices ?country= ar &amp;cua_type_period= lbl_mensual &amp;cua_type= activo &#160;&#160; 
&#160; 
 https&#58;// dev .datagov.eatcloud.info/api/eatcloud/ eatc_licenses_prices ?country= ar &amp;cua_type_period= lbl_mensual &amp;cua_type= esencial &#160; 
&#160; 
...
&#160; 
 Si los puntos de donacin activos se encuentran dentro de estos lmites, se proceder con la consulta para establecer si los KG gestionados estn dentro del lmite (prxima prueba).&#160; Si el nmero de puntos activos no se encuentra dentro de los lmites establecidos, se procede a mostrar el Botn&#58; Consulte su precio con un asesor , que se especifica ms abajo. 
...
&#160; 
 ...
 eatc_cua = &#123;&#123;_DOM. cua_user &#125;&#125; 
 eatc_platform = datagov_cuentas 
 eatc_upgrade_event = &#123;&#123;eatc_details_of_licenses .eatc_licence_code &#125;&#125;_comprar_1 
 eatc_user = &#123;&#123; URL_entorno_donantes &#125;&#125;/api/&#123;&#123;_DOM. cua_user &#125;&#125;/ bo_usuarios? nombre_usuario = &#123;&#123; bo_usuarios. nombre_usuario &#125;&#125;&amp;_distinct = email 
 eatc_actual_rescue_plan = &#123;&#123; URL_entorno_datagov &#125;&#125;/api/eatcloud/ eatc_cua ?name=&#123;&#123;_DOM. cua_user &#125;&#125;&amp;_distinct =type 
...
&#160; 
 ...
 eatc_cua = abaco 
 eatc_platform = datagov_cuentas 
 eatc_upgrade_event = esencial_comprar_1 
...
&#160; 
 ***NUEVO*** DESCRIPCIN DE LA LICENCIA &#58; 
 Mostrar el label&#58; 
...
&#160; 
 D ETALLES DE LA LICENCIA &#58; ***SIEMPRE SE DEBEN MOSTRAR AS NO HALLA PRECIO DE LISTA DEFINIDO*** 
 Mostrarn los labels que se obtienen de la siguiente consulta 
 &#123;&#123; URL_entorno_datagov &#125;&#125;/api/eatcloud/ eatc_details_of_licenses? eatc_licence_code =&#123;&#123;eatc_details_of_licenses .eatc_licence_code &#125;&#125;&amp; eatc_implemented =y&amp; eatc_additional_info =n &amp; _distinct = eatc_detail_description_lbl 
&#160; 
 En el orden que se obtiene en el parmetro eatc_details_of_licenses. eatc_order 
 &#123;&#123; URL_entorno_datagov &#125;&#125;/api/eatcloud/ eatc_details_of_licenses? eatc_licence_code= &#123;&#123;eatc_details_of_licenses .eatc_licence_code &#125;&#125; &amp;eatc_implemented=y&amp;eatc_additional_info=n 
&#160; 
 Ejemplo &#58;&#160; ambiente de pruebas , eatc_details_of_licenses .eatc_licence_code= free 
 https&#58;//dev.datagov.eatcloud.info /api/eatcloud/ eatc_details_of_licenses? eatc_licence_code= free &amp;eatc_implemented=y&amp;eatc_additional_info=n &amp; _distinct =eatc_detail_description_lbl &#160;&#160; &#160; &#160; 
&#160; 
 Dado que se obtiene la siguiente respuesta&#58; 
 &#123; 
 eatc_detail_description_lbl &#58; &quot;lbl_acceso_red_ast&quot; 
 &#125;, 
 &#123; 
 eatc_detail_description_lbl &#58; &quot;lbl_constancia_donacion_ast&quot; 
 &#125;, 
 &#123; 
 eatc_detail_description_lbl &#58; &quot;lbl_certificado_donacion_ast&quot; 
 &#125;, 
 &#123; 
 eatc_detail_description_lbl &#58; &quot;lbl_acceso_tutoriales_en_linea_ast&quot; 
 &#125;, 
 &#123; 
 eatc_detail_description_lbl &#58; &quot;lbl_un_pod&quot; 
 &#125;, 
 &#123; 
 eatc_detail_description_lbl &#58; &quot;lbl_tres_donaciones_mes&quot; 
 &#125;, 
 &#123; 
 eatc_detail_description_lbl &#58; &quot;lbl_soporte_tecnico_formulario_36h&quot; 
 &#125;, 
 &#123; 
 eatc_detail_description_lbl &#58; &quot;lbl_un_usuario_administrador&quot; 
 &#125; 
&#160; 
 Se disponen dichos labels en el orden que dicta la consulta 
 https&#58;//dev.datagov.eatcloud.info /api/eatcloud/ eatc_details_of_licenses? eatc_licence_code=free&amp;eatc_implemented=y&amp;eatc_additional_info=n &#160; 
...
&#160; 
 ...
 eatc_cua = &#123;&#123;_DOM. cua_user &#125;&#125; 
 eatc_platform = datagov_cuentas 
 eatc_upgrade_event = &#123;&#123;eatc_details_of_licenses .eatc_licence_code &#125;&#125;_comprar_2 
 eatc_user = &#123;&#123; URL_entorno_donantes &#125;&#125;/api/&#123;&#123;_DOM. cua_user &#125;&#125;/ bo_usuarios? nombre_usuario = &#123;&#123; bo_usuarios. nombre_usuario &#125;&#125;&amp;_distinct = email 
 eatc_actual_rescue_plan = &#123;&#123; URL_entorno_datagov &#125;&#125;/api/eatcloud/ eatc_cua ?name=&#123;&#123;_DOM. cua_user &#125;&#125;&amp;_distinct =type 
...
&#160; 
 ...
 eatc_cua = abaco 
 eatc_platform = datagov_cuentas 
 eatc_upgrade_event = esencial_comprar_2 
 eatc_user = https&#58;//devdonantes.eatcloud.info//api/ abaco / bo_usuarios? nombre_usuario = abaco&amp;_distinct =email = jdr@nodrizza.com 
 eatc_actual_rescue_plan = https&#58;//dev.datagov.eatcloud.info/api/eatcloud/ eatc_cua ?name= abaco &amp;_distinct =type = free 
&#160; 
 Entonces se realiza el siguiente llamado al API de creacin de registro 
 https&#58;//dev.datagov.eatcloud.info/crd/eatcloud/?_tabla=eatc_upgrade_events&amp;_operacion=insert&amp; eatc_datetime =2021-09-11%2014&#58;43&#58;00&amp; eatc_date =2021-09-11&amp; eatc_country= co&amp; eatc_cua_master =abaco&amp; eatc_cua =abaco&amp; eatc_platform =datagov_cuentas&amp; eatc_upgrade_event = esencial_comprar_2 &amp; eatc_user =jdr@nodrizza.com&amp; eatc_actual_rescue_plan =free 
...
&#160; 
 ...
 https://eatcloudcorp.sharepoint.com/_layouts/15/getpreview.ashx?path=%2Fsites%2FEatCloud2%2FSiteAssets%2FSitePages%2Finformaci%C3%B3n-planes%2F1853028269-info_planes_rescate.jpg&ow=854&oh=892, https://eatcloudcorp.sharepoint.com/_layouts/15/getpreview.ashx?path=%2Fsites%2FEatCloud2%2FSiteAssets%2FSitePages%2Finformaci%C3%B3n-planes%2F1853028269-info_planes_rescate.jpg&ow=854&oh=892 

 462.000000000000 

 INFORMACIN PLANES (RESCATE)